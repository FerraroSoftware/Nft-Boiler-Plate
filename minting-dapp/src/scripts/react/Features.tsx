        ...
        <section id="features">
          <div className="container  flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
            ...
            <div className="flex flex-col space-y-8 md:w-1/2 mx-10 my-10">
              <div className="flex grow flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    after the public mint, 30% of the wallet will be sent
                    directrly to Save a Fox, the greatest Fox Sanctuary there
                    is.
                  </p>
                </div>
              </div>
              ...
              <div className="flex grow flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    ...
                    support. A portion of initial mints will be put into a
                    community wallet, to donate, make purchases and airdrops.
                  </p>
                </div>
              </div>
              {/* <!-- list item 3 --> */}
              <div className="flex grow flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    A portion of the initial mint will go the team, initial
                    fees, promotions and future events to come. We plan to
                    dedicate a portion of this to growing the community and
                    raising awareness.
                  </p>
                </div>
              </div>
